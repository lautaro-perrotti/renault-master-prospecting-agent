...
export const contacts=pgTable('contacts',{
  id:uuid('id').defaultRandom().primaryKey(),companyId:uuid('company_id').references(()=>companies.id).notNull(),email:text('email'),phone:text('phone'),kind:text('kind'),role:text('role').notNull().default('UNKNOWN'),sourceUrl:text('source_url'),
